...
pub fn icon_pixbuf() -> gtk4::gdk_pixbuf::Pixbuf {
    let loader = gtk4::gdk_pixbuf::PixbufLoader::new();
    loader.write(ICON_256_PNG).expect("icon_256.png");
    loader.close().expect("icon_256.png close");
    loader.pixbuf().expect("icon_256.png pixbuf")
}
